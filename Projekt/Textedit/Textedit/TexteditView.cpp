...
bool CTexteditView::Load(const TCHAR* sPath, UINT uiFlag)
{
...
bool CTexteditView::Save(const TCHAR* sPath, UINT uiFlag)
{
...
void CTexteditView::SetNamePath(const TCHAR* path)
{
	lstrcpy(m_path, path);
...
bool CTexteditView::DoLoad(const TCHAR* sPath, UINT uiFlag)
{
...
bool CTexteditView::DoSave(const TCHAR* sPath, UINT uiFlag)
{
...
int  CTexteditView::GetType(const TCHAR* sPath) const
{
	int r = FMT_TXT;
...
const TCHAR* CTexteditView::RFind(const TCHAR* str, const TCHAR ch)
{
	TCHAR* p = (TCHAR*)str;
	while (*p++);
	while (--p != str)
...
const TCHAR* CTexteditView::RFind(const TCHAR* str, const TCHAR* ss)
{
	TCHAR* p = (TCHAR*)str;
	while (*p++);
	while (--p != str) {
